    ...
    Box(modifier = modifier) {
        Column(
            modifier = Modifier
                ...
                .padding(end = 10.dp, start = 10.dp, bottom = 23.dp),
            ...
            Row(
                ...
                CalculatorButton(
                    ...
                    modifier = Modifier
                        ...
                        .aspectRatio(1f)
                        .weight(1f),
                    onClick = { onAction(CalculatorActions.Operation(CalculatorOperation.Minus)) }
                )
            }
            Row(
                modifier = Modifier.fillMaxWidth(),
                ...
                CalculatorButton(
                    ...
                    modifier = Modifier
                        ...
                        .aspectRatio(1f)
                        .weight(1f),
                    onClick = { onAction(CalculatorActions.Operation(CalculatorOperation.Plus)) }
                )
            }
            Row(
                modifier = Modifier.fillMaxWidth(),
